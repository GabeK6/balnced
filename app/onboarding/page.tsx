...
export default function OnboardingPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (error) {
      ...
      alert(
        `Could not save: ${message}${err.details ? ` (${err.details})` : ""}`
      );
      return;
    }
  ...
  if (pageLoading) {
    return (
      <main className="min-h-screen bg-slate-100 px-4 py-10 dark:bg-slate-900 sm:px-6 lg:px-8 xl:px-10 2xl:px-12">
  ...
  return (
    <main className="min-h-screen bg-slate-100 px-4 py-8 dark:bg-slate-900 sm:px-6 lg:px-8 xl:px-10 2xl:px-12">
      <div className="mx-auto max-w-6xl space-y-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <Link
              href="/dashboard"
              className="inline-flex shrink-0 items-center gap-1.5 rounded-2xl bg-emerald-100 px-4 py-2.5 text-sm font-medium text-emerald-700 shadow-sm ring-1 ring-emerald-200/50 transition hover:bg-emerald-200 dark:bg-emerald-900/50 dark:text-emerald-300 dark:ring-emerald-700/50 dark:hover:bg-emerald-800/50"
            >
              <svg
                className="h-4 w-4"
                fill="none"
            ...
            <p className="mt-2 max-w-xl text-sm leading-relaxed text-slate-500 dark:text-slate-400">
              Update your balance, pay setup, pay frequency, and next payday.
              These values drive safe-to-spend, daily limits, projections,
              retirement defaults, and recommendations.
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-5 sm:gap-6 xl:grid-cols-[1.1fr_0.9fr]">
          <div className="balnced-panel rounded-3xl p-5 sm:p-6">
            ...
            <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
              Balance, pay type, frequency, income, and next payday.
            </p>
            ...
            <form onSubmit={handleSubmit} className="mt-5 space-y-5 sm:mt-6">
                ...
                <>
                  ...
                  <div className="balnced-row rounded-xl p-4 sm:p-5">
                    ...
                    <p className="mt-0.5 text-xs text-slate-500 dark:text-slate-400">
                      Hourly rate × hours per pay period
                    </p>
                  </div>
                </>
              )}
              ...
              <div className="flex flex-wrap gap-3 pt-3">
                ...
                <button
                  ...
                  className="min-h-[2.75rem] rounded-xl bg-slate-100 px-5 py-2.5 text-sm font-medium text-slate-700 transition hover:bg-slate-200 dark:bg-slate-700 dark:text-slate-200 dark:hover:bg-slate-600"
                >
                  Cancel
                </button>
              </div>
          ...
          <div className="space-y-5 sm:space-y-6">
            <div className="balnced-panel rounded-3xl p-5 sm:p-6">
              ...
              <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
                Saving here recalculates the following across the app.
              </p>
              <ul className="mt-4 space-y-3">
                <li className="flex gap-3 balnced-row rounded-xl p-4">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-sm text-slate-500 dark:text-slate-400">
                      Uses your current balance, bills, and expenses to show how much you can spend before the next payday.
                    </p>
                  </div>
                </li>
                <li className="flex gap-3 balnced-row rounded-xl p-4">
                ...
                <li className="flex gap-3 balnced-row rounded-xl p-4">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-sm text-slate-500 dark:text-slate-400">
                      If you haven’t set a salary there, the Retirement tab will use your annual income from here as the default.
                    </p>
                  </div>
                </li>
                <li className="flex gap-3 balnced-row rounded-xl p-4">
            ...
            <div className="balnced-panel rounded-3xl p-5 sm:p-6">
              ...
              <ul className="mt-4 space-y-2.5 text-sm leading-relaxed text-slate-500 dark:text-slate-400">
